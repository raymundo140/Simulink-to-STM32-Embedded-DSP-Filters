...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define ADC_MID_VALUE   2048.0   // mid-scale for 12-bit ADC
#define ADC_SCALE       2047.0   // so +/-1 maps to almost full scale
...
/* USER CODE BEGIN PV */
volatile filter_t current_filter = FILTER_BPF;   // choose filter
